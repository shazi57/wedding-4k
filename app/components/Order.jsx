export default function() {
  return (
    <div className="rotated absolute left-[50vw] w-[45vw] h-[71vh] top-[8vh] h-screen">
      <div className="text-[5vw] text-right tracking-widest font-cinzel">
        Order
          <span className="font-alex">of</span>
        Events
      </div>
      <div className="text-[2.5vw] text-right mr-[0.5vw] font-bodoni">VICTOR AND JOY</div>
      <div className="text-[1vw] text-right mr-[1vw] font-cinzel">Twenty Twenty Two</div>
      <div className="grid grid-rows-[repeat(9,min-content)] grid-cols-[min-content_max-content] gap-[1vw] w-[100%] h-[100%] mt-[4vh]">
        ...
        <div className="text-[2.5vw] tracking-widest font-rajdhani">SEND OFF</div>
      </div>
    </div>
  );
}